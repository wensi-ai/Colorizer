...
from models.InstaColor.data.base_data_loader import BaseDataLoader
from models.InstaColor.data.base_dataset import BaseDataset
...
def find_dataset_using_name(dataset_name):
    ...
    # will be imported.
    dataset_filename = "models.InstaColor.data." + dataset_name + "_dataset"
